                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="profile-blog pt-3 border-bottom-1 pb-1">
                            ...
                            <img src="{{asset('backend/images/profile/1.jpg')}}" alt="" class="img-fluid mt-4 mb-4 w-100">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                    <a href="javascript:void()" class="interest-cat">
                                        <img src="{{asset('backend/images/profile/2.jpg')}}" alt="" class="img-fluid">
                                        <p>Shopping Mall</p>
                                    </a>
                                </div>
                                <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                    <a href="javascript:void()" class="interest-cat">
                                        <img src="{{asset('backend/images/profile/3.jpg')}}" alt="" class="img-fluid">
                                        <p>Photography</p>
                                    </a>
                                </div>
                                <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                    <a href="javascript:void()" class="interest-cat">
                                        <img src="{{asset('backend/images/profile/4.jpg')}}" alt="" class="img-fluid">
                                        <p>Art &amp; Gallery</p>
                                    </a>
                                </div>
                                <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                        ...
                        <div class="profile-news mt-4 pb-3">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{asset('backend/images/profile/5.jpg')}}" alt="image" class="mr-3">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{asset('backend/images/profile/6.jpg')}}" alt="image" class="mr-3">
                                <div class="media-body">
                                    <h5 class="m-b-5">John Tomas</h5>
                                    <p>I shared this on my fb wall a few months back, and I thought I'd share it here again because it's such a great read</p>
                                </div>
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{asset('backend/images/profile/7.jpg')}}" alt="image" class="mr-3">
                                <div class="media-body">
                                    <h5 class="m-b-5">John Tomas</h5>
                                    <p>I shared this on my fb wall a few months back, and I thought I'd share it here again because it's such a great read</p>
                                </div>
